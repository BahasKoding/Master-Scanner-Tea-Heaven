...
<div class="row">
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        <h5>Add Rows</h5>
        <small>New rows can be added to a DataTable using the row.add() API method. Simply call the API function with the data for the
          new row
        </small>
      </div>
      <div class="card-body">
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        ...
        <small>The searching functionality provided by DataTables is useful for quickly search through the information in the table -
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        ...
        <small>This example is almost identical to text based individual column example and provides the same functionality, but in this
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        ...
        <small>It can be useful to provide the user with the option to select rows in a DataTable. This can be done by using a click
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        ...
        <small>This example modifies the multiple row selection example by only allowing the selection of a single row. This is done by
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        <h5>Form Inputs</h5>
        <small>In order to perform paging, ordering, searching etc, DataTables can remove rows and cells from the document (i.e. those
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        ...
        <small>This example shows how you can make use of the column().visible() API method to dynamically show and hide columns in a
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        ...
        <small>Searching a table is one of the most common user interactions with a DataTables table, and DataTables provides a number
