...
<div class="modal fade" id="setPermissionsModal" tabindex="-1" aria-labelledby="setPermissionsModalLabel" aria-hidden="true">
...
<script>
    ...
    function savePermissions(roleId) {
        let selectedPermissions = Array.from(document.querySelectorAll('#setPermissionsForm input:checked')).map(el => el.value);
