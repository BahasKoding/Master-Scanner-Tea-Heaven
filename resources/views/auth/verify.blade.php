            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('verification.verify') }}" id="verifyForm">
                    ...
                    <div class="row my-4 g-3 text-center">
                        <div class="col">
                            <input type="text" class="form-control text-center otp-input" id="otp1" name="digit1"
                                maxlength="1" required autofocus oninput="moveToNext(this, 'otp2')">
                        </div>
                        <div class="col">
                            <input type="text" class="form-control text-center otp-input" id="otp2" name="digit2"
                                maxlength="1" required oninput="moveToNext(this, 'otp3')">
                        </div>
                        <div class="col">
                            <input type="text" class="form-control text-center otp-input" id="otp3" name="digit3"
                                maxlength="1" required oninput="moveToNext(this, 'otp4')">
                        </div>
                        <div class="col">
                            <input type="text" class="form-control text-center otp-input" id="otp4" name="digit4"
                                maxlength="1" required oninput="moveToNext(this, '')">
                        </div>
                    </div>
